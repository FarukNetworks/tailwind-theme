...
function tailpress_enqueue_scripts()
{
  ...
  wp_enqueue_script('custom-js', tailpress_asset('js/custom.js'), array());
  wp_enqueue_script('gsap-js', tailpress_asset('js/gsap.js'), array('jquery', 'gsap', 'gsap-scrolltrigger', 'lenis'));
}
